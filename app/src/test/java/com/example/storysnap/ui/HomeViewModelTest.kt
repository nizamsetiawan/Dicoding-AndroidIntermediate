package com.example.storysnap.ui
...
import com.example.storysnap.DataDummy
import com.example.storysnap.MainDispatcherRule
...
import com.example.storysnap.getOrAwaitValue
...
class TestingMyViewModel {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(appRepository.getStories("token")).thenReturn(expectedStory)
        ...
        val differ = AsyncPagingDataDiffer(
            diffCallback = StoriesAdapter.LIST_STORY_DIFF_CALLBACK,
